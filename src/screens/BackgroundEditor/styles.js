...
export const styles = StyleSheet.create({
  ...
  gradientStopBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10, paddingHorizontal: 12, borderRadius: 12, backgroundColor: '#f3f4f6', borderWidth: 1, borderColor: '#e5e7eb' },
  gradientStopBtnActive: { backgroundColor: '#dbeafe', borderColor: '#3b82f6' },
  gradientStopSwatch: { width: 18, height: 18, borderRadius: 6, borderWidth: 1, borderColor: 'rgba(0,0,0,0.12)' },
  gradientStopText: { fontSize: 12, fontWeight: '800', color: '#6b7280' },
  gradientStopTextActive: { color: '#111827' },
  ...
  addTextBtn: { backgroundColor: '#3b82f6', borderRadius: 12, paddingVertical: 12 },
  addTextBtnLabel: { color: 'white', fontWeight: '900' },
  editTextContainer: { marginTop: 14, padding: 12, backgroundColor: '#ffffff', borderRadius: 14, borderWidth: 1, borderColor: '#f3f4f6' },
  textEditInput: { height: 44, borderRadius: 12, paddingHorizontal: 12, backgroundColor: '#f3f4f6', color: '#111827', fontWeight: '800' },
  ...
  textActionBtnPrimary: { backgroundColor: '#111827' },
  textActionBtnPrimaryLabel: { color: '#fff', fontWeight: '900' },
  ...
  textColorDot: { width: 30, height: 30, borderRadius: 15, borderWidth: 1, borderColor: 'rgba(0,0,0,0.10)' },
  textColorDotActive: { borderWidth: 2, borderColor: '#111827' },
